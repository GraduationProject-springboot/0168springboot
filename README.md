...
# 0168springboot工厂车间管理系统的设计

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1jqaLe1ECs?p=66)


# 第1章 绪论
## 1.1 研究背景
互联网时代不仅仅是通过各种各样的电脑进行网络连接的时代，也包含了移动终端连接互联网进行复杂处理的一些事情。传统的互联网时代一般泛指就是PC端，也就是电脑互联网时代，但是最近几十年，是移动互联网时代，是向下一步互联网时代过度的一个重要时代，下一个互联网时代叫物联网，而移动互联网就是一个风口，是当前社会的主流风向。目前移动互联网大行其道，人人都手中拿着智能机，手机手机，手不离机，如果开发一个用在手机上的程序软件，那是多么的符合潮流，符合管理者和客户的理想。本次就是开发基于VUE的工厂车间管理系统，有管理员和人员两个角色。管理员功能有个人中心，人员管理，看板信息管理，设备信息管理，生产开立管理，生产工序管理，生产流程管理。注册的人员可以登录和查看管理员发布的所有信息。
## 1.2 研究现状
...
此次开发这个基于VUE的工厂车间管理系统，不仅仅满足用户的需要，也能跟上时代的发展风向，从技术的角度还是用户的角度上进行开发都是很有意义的。
## 1.4 论文研究内容
...
|10|renyuanleixing|String|人员类型|是|
2生产工序表
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|shengchanpici|String|生产批次|是|
|4|gongxumingcheng|String|工序名称|是|
|5|gongxubianhao|String|工序编号|是|
|6|shebeimingcheng|String|设备名称|是|
|7|picishuliang|Integer|批次数量|是|
|8|gongxuneirong|String|工序内容|是|
|9|chanpinmingcheng|String|产品名称|是|
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|gongdanshuliang|Integer|工单数量|是|
|4|shengchanpici|String|生产批次|是|
|5|picishuliang|Integer|批次数量|是|
|6|picishuoming|String|批次说明|是|
|7|chanpinmingcheng|String|产品名称|是|
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|kanbanmingcheng|String|看板名称|是|
|4|yulantu|String|预览图|是|
|5|wangyelianjie|String|网页链接|是|
|6|neirongshuoming|String|内容说明|是|
5生产流程表
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|shengchanpihao|String|生产批号|是|
|4|shengchanpici|String|生产批次|是|
|5|gongxumingcheng|String|工序名称|是|
|6|gongxubianhao|String|工序编号|是|
|7|shebeimingcheng|String|设备名称|是|
|8|picishuliang|Integer|批次数量|是|
|9|chanpinmingcheng|String|产品名称|是|
|10|shengchanzhuangtai|String|生产状态|是|
6设备信息表
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|shebeibianhao|String|设备编号|是|
|4|shebeimingcheng|String|设备名称|是|
|5|shebeileixing|String|设备类型|是|
|6|guimo|String|规模|是|
